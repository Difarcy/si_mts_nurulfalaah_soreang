                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="flex items-center justify-end gap-3 translate-y-2">
                        ...
                        <button type="submit" id="submit-btn" disabled
                            class="inline-flex items-center justify-center px-4 py-1.5 text-base font-semibold text-white bg-green-700 hover:bg-green-800 transition-colors min-w-20 disabled:opacity-50 disabled:cursor-not-allowed rounded">
                            Simpan
                        </button>
                    </div>
                </div>
