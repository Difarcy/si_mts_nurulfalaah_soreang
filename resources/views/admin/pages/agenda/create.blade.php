...
@section('content')
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100">Tambah Agenda</h1>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Buat agenda kegiatan baru yang akan ditampilkan
                    di website</p>
            </div>
        ...
        <form action="{{ route('cpanel.agenda.store') }}" method="POST" id="agenda-form" data-unsaved-changes="true"
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="body-editor" rows="10" placeholder="Masukkan deskripsi agenda"
                            class="w-full border-2 border-gray-200 dark:border-slate-600 px-3 py-2.5 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:border-green-600 focus:outline-none rounded">{{ old('deskripsi') }}</textarea>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="author_name" id="author_name"
                                    value="{{ old('author_name', 'Admin') }}" required maxlength="100"
                        ...
                        <div class="pt-2 border-t border-gray-200 dark:border-slate-700">
                            ...
                            <div class="relative">
                                ...
                                <span
                                    class="absolute right-3 top-1/2 -translate-y-1/2 text-xs pointer-events-none text-slate-400 dark:text-slate-500">
                                    <span id="lokasi_count">{{ mb_strlen(old('lokasi')) }}/255</span>
                                </span>
                            </div>
