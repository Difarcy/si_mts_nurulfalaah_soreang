                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center justify-end gap-3 translate-y-2">
                            ...
                            <button type="submit" id="publish-btn" disabled
                                class="inline-flex items-center justify-center px-4 py-1.5 text-base font-semibold text-white bg-green-700 hover:bg-green-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed rounded">Publish</button>
                        </div>
                    </div>
                </div>
            </div>
